...
const ProductCard: FC<Props> = ({ product }) => {
  ...
  return (
    <div className="w-[300] bg-white rounded-2xl shadow-[var(--box-shadow)] hover:shadow-[var(--box-hover-shadow)] overflow-hidden text-center cursor-pointer flex flex-col transition-shadow duration-300">
